...
class ContactsListTableViewController: UITableViewController {
    ...
    let contact: [Contact] = [
        ...
        Contact(name: "Vadim", phoneNumber: "89953305484"),
        Contact(name: "Rinat", phoneNumber: "89969012938"),
        Contact(name: "Almaz", phoneNumber: "89273375484"),
        Contact(name: "Vadim", phoneNumber: "89953305484"),
        Contact(name: "Rinat", phoneNumber: "89969012938"),
        Contact(name: "Almaz", phoneNumber: "89273375484")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.phoneLabel.text = contact[indexPath.row].phoneNumber
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        contactInfo.item = contact[indexPath.row]
